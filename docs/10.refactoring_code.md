...
<font color="#FFD700"><b>핵심 메시지: 리팩토링의 목적은 기능 추가보다 변경 비용을 줄이는 구조를 만드는 것입니다.</b></font>
...
### 무엇이 좋아졌나?
- <font color="green"><b>책임 분리(SRP)</b></font>: 판단, 포워딩, 패스워드 로딩, URL 생성이 각각 클래스로 분리됨
...
### 무엇이 좋아졌나?
- <font color="green"><b>모델 소스 선택 로직이 별도 클래스로 이동 (SRP)</b></font>
...
- 색인 구조 변경이 쉬움
- <font color="red"><b>색인 파이프라인을 한 클래스에 다시 합치면, 변경 영향 범위가 다시 커집니다.</b></font>
...
### 왜 바꿨나?
- `ProductSearchService`가 검색 구현까지 직접 갖고 있어 확장이 어려웠습니다.
...
- <font color="#FFD700"><b>즉, 유지보수 난이도를 낮추는 구조적 투자입니다.</b></font>
