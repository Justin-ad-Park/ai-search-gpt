...
핵심 규칙:
- `user_dictionary` 값은 Elasticsearch 컨테이너의 <font color="blue"><b>config 디렉터리 기준 상대경로</b></font>로 해석됩니다.
...
포인트:
- <font color="green"><b>`00_5`를 `00_6`보다 먼저 실행해, 처음부터 마운트 누락을 방지합니다.</b></font>
